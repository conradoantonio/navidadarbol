                    ...
                    <div class="grid-body">
                    	<div class="col-sm-12 col-xs-12">
				            <div class="alert alert-info alert-dismissible text-left" role="alert">
						        ...
						        - Las notificaciones que se envíen no se guardarán en el sistema.<br>
						    </div>
						</div>
					    <div class="col-md-12">
										                ...
										                <div class="form-group">
															...
															<select name="usuarios_id[]" id="usuarios_id" class="select2" multiple="multiple" style="width: 100%">
																...
																@foreach($usuarios as $usuario)
																	<option value="{{$usuario->player_id}}">{{$usuario->nombre}} {{$usuario->apelido}}</option>
																@endforeach
															</select>
														</div>
							                        </div>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#fecha_general').datepicker('setStartDate', "{{$start_date}}");
	})
</script>
@endsection